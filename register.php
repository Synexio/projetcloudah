...
<body class="register" id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">Inscris-toi !</h1>
...
<?php
    if( isset($_SESSION["errorsForm"]) ){
      foreach ($_SESSION["errorsForm"] as $keyError) {
        echo "<li class='alert alert-danger'>".$listOfErrors[$keyError]."</li>";
      }
    ...
    <form method="POST" action="saveUser.php" enctype="multipart/form-data">
      ...
      <div class="form-row">
        ...
        <div class="form-group col">
          ...
          value="<?php
          echo (isset($_SESSION["postForm"]["lastname"]))?$_SESSION["postForm"]["lastname"]:"";
          ?>">
        </div>
        ...
        <div class="form-group col">
          ...
          value="<?php
          echo (isset($_SESSION["postForm"]["firstname"]))?$_SESSION["postForm"]["firstname"]:"";
          ?>">
        </div>
      ...
      <div class="form-group">          
        ...
        value="<?php
        echo (isset($_SESSION["postForm"]["email"]))?$_SESSION["postForm"]["email"]:"";
        ?>">
      </div>
      ...
      <button type="submit" class="btn btn-dark">S'inscrire dès maintenant</button>
    </form>
  </div>
  </header>
